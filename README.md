...
| [Meshcomod](https://github.com/ALLFATHER-BV/meshcomod) ![GitHub Repo stars](https://img.shields.io/github/stars/ALLFATHER-BV/meshcomod?style=social) | **Heltec V4 / V3, Wireless Paper, Xiao (companion); Heltec V4 touch & LilyGo T-Deck (touch UI).** MeshCore addon in two flavours: a multi-transport companion serving **USB + Bluetooth + TCP simultaneously** (drive it from a phone app, web client, or Home Assistant), and a standalone LVGL [touch UI](https://meshcomod.com/touch.html) — on-device chat, channels, rooms, contacts, live map, and over-the-air updates, no phone required. Pre-built binaries included. | ![GitHub last commit](https://img.shields.io/github/last-commit/ALLFATHER-BV/meshcomod) |
